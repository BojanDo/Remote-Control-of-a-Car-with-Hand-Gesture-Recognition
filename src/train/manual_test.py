...
def manual_tests():
    ...
    generate_confusion_matrix(_3_model, "Ensemble Confusion Matrix (3 models)",
                              "manual/confusion_matrix_3_model.png")
    ...
    generate_confusion_matrix(_5_model, "Ensemble Confusion Matrix (5 models)",
                              "manual/confusion_matrix_5_model.png")
